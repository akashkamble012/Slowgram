...
import com.akashkamble.slowgram.Adapter.CommentAdapter;
...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        androidx.appcompat.widget.Toolbar toolbar = (androidx.appcompat.widget.Toolbar) findViewById(R.id.CommentActivityToolBar);
        ...
        imageProfile = (CircleImageView) findViewById(R.id.imageProfileForComments) ;
